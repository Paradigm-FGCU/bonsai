...
public class MultiChoiceActivity extends CActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setQuestionView();
		aBar.setTitle("Bonsai: " + RunningInfo.getSelectedDeck().getDeckName()
				+ " Quiz");
		// Timer for Quiz Mode
		if (RunningInfo.getTimedQuiz()) {

			mCountDown = new CountDownTimer((RunningInfo.getQuizTime() * 1000),
					1000) {
				...
				public void onFinish() {
					...
					cardTime[cards.size()] = cardTime[cards.size()]
							+ cardTime[qid];
					...
					if ((qid != (cards.size() - 1))) {
						...
						Intent intent = new Intent(MultiChoiceActivity.this,
	...
	public boolean onKeyDown(int keycode, KeyEvent event) {
		if (keycode == KeyEvent.KEYCODE_BACK) {
			...
			Intent i = new Intent(MultiChoiceActivity.this,
